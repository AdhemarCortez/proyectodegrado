                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets/img/logo.jpg" width="300">
                                    
                                    <h3 class="font-weight-light my-2">SISTEMA CONTROL DE ACTIVOS FIJOS</h3>                                    
                                </div>
                                <div class="card-body">
                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        ...
                        <div>
                            ...
                            &middot;
                            <a href="#">Universidad Salesiana de Bolivia</a>
                        </div>
                    </div>
                </div>
            </footer>
