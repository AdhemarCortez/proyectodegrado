...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        $direccion = $_POST['direccion'];
            ...
            if ($sql_update) {
                $alert = '<div class="alert alert-success" role="alert">Responsable Actualizado correctamente</div>';
            } else {
                $alert = '<div class="alert alert-danger" role="alert">Error al Actualizar el Responsable</div>';
            }
    }
}
// Mostrar Datos
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="" action="" method="post">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-user-edit"></i> Editar Responsable</button>
