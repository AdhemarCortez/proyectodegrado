     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header bg-primary text-white">
                 <h5 class="modal-title" id="my-modal-title">Nuevo Activo Fijo</h5>
             ...
             <div class="modal-body">
                 <form action="" method="post" autocomplete="off">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" placeholder="Ingrese Nombre de Activo Fijo" name="codigo" id="codigo" class="form-control">
                     </div>
                     <div class="form-group">
                         <label for="producto">Descripción</label>
                         <input type="text" placeholder="Ingrese descripción del activo" name="producto" id="producto" class="form-control">
                     </div>
                     <div class="form-group">
                     ...
                     <input type="submit" value="Guardar Activo Fijo" class="btn btn-primary">
                 </form>
             </div>
         </div>
     </div>
