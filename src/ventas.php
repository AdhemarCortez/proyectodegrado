...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            <h5 class="text-center">Datos del Responsable</h5>
        </div>
        <div class="card">
            <div class="card-body">
                <form method="post">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white text-center">
                <h5>Datos Asignación</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label><i class="fas fa-user"></i> AUTORIZADO POR: </label>
            ...
            <table class="table table-hover" id="tblDetalle">
                ...
                <tfoot>
                    <tr class="font-weight-bold">
                        <td colspan=3>Total Asignación</td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
    ...
    <div class="col-md-6">
        <a href="#" class="btn btn-primary" id="btn_generar"><i class="fas fa-save"></i> Asignar Activo Fijo</a>
    </div>
