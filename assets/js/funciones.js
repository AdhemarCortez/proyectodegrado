    ...
    $('#btn_generar').click(function (e) {
        ...
        if (rows > 2) {
                ...
                success: function (response) {
                    ...
                    if (response != 'error') {
                        ...
                        Swal.fire({
                            position: 'top-end',
                            icon: 'error',
                            title: 'Error al generar la asignación',
                            showConfirmButton: false,
                            timer: 2000
                        })
                    }
            ...
            Swal.fire({
                position: 'top-end',
                icon: 'warning',
                title: 'No hay activo fijo para generar la asignación',
                showConfirmButton: false,
                timer: 2000
            })
        }
                    ...
                    success: function (response) {
                        if (response == 'registrado') {
                            ...
                            Swal.fire({
                                position: 'top-end',
                                icon: 'error',
                                title: 'Error al ingresar el activo',
                                showConfirmButton: false,
                                timer: 2000
                            })
                        }
        ...
        success: function (response) {
            ...
            if (response == 'restado') {
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
                    title: 'Error al eliminar el activo fijo',
                    showConfirmButton: false,
                    timer: 2000
                })
            }
